...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer' => '© Derechos de autor 2019 - :current_year, Webkul Software (Registrado en India). Todos los derechos reservados.',
        ...
        'reset-password' => [
            ...
            'footer' => '© Derechos de autor 2019 - :current_year, amvsoft.tech. Todos los derechos reservados.',
            'password' => 'Contraseña',
    ...
    'complaint-book' => [
        'create' => [
            ...
            'subtitle' => 'Conforme al Código de Protección y Defensa del Consumidor (Ley N.° 29571), este establecimiento cuenta con un Libro de Reclamaciones a su disposición. La formulación del reclamo no impide acudir a otras vías de solución de controversias ni es requisito previo para interponer una denuncia ante el INDECOPI.',
            'response-time-notice' => 'Tu reclamo o queja será atendido en un plazo no mayor a 15 días hábiles.',
            'consumer-section' => '1. Identificación del consumidor reclamante',
            'document-type' => 'Tipo de documento',
            'document-type-dni' => 'DNI',
            'document-type-ce' => 'Carné de Extranjería',
            ...
            'phone' => 'Teléfono',
            'email' => 'Correo electrónico',
            'good-section' => '2. Identificación del bien contratado',
            'good-type' => 'Tipo de bien contratado',
            'good-type-product' => 'Producto',
            'good-type-service' => 'Servicio',
            'good-description' => 'Descripción del producto o servicio',
            'claimed-amount' => 'Monto reclamado (S/, opcional)',
            'claim-section' => '3. Detalle de la reclamación y pedido del consumidor',
            'type' => 'Tipo',
            'type-claim' => 'Reclamo',
            'type-claim-desc' => 'Disconformidad relacionada a los productos o servicios.',
            'type-complaint' => 'Queja',
            'type-complaint-desc' => 'Disconformidad no relacionada a los productos o servicios; o malestar respecto a la atención al público.',
            'detail' => 'Detalle',
            'request' => 'Pedido del consumidor',
            'accept-privacy' => 'He leído y acepto que mis datos sean tratados conforme a la :link, para dar trámite a este reclamo.',
            'privacy-policy-link' => 'Política de Privacidad',
            'submit' => 'Enviar reclamo',
            'success' => 'Tu reclamo fue registrado con el N.° :correlative. Te responderemos en un plazo no mayor a 15 días hábiles al correo indicado.',
            'lookup-not-found' => 'No se encontró información para el documento ingresado. Completa tus datos manualmente.',
            'lookup-failed' => 'No se pudo verificar el documento en este momento. Completa tus datos manualmente.',
            'lookup-unavailable' => 'La verificación automática no está disponible. Completa tus datos manualmente.',
        ],
    ],
