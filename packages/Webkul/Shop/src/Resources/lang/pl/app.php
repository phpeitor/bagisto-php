...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer' => '© Prawa autorskie 2019 - :current_year, Webkul Software (zarejestrowane w Indiach). Wszelkie prawa zastrzeżone.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text' => '© Prawa autorskie 2019 - :current_year, Webkul Software (zarejestrowane w Indiach). Wszelkie prawa zastrzeżone.',
                'locale' => 'Lokalizacja',
