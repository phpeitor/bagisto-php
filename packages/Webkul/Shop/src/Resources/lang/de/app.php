...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer' => '© Copyright 2019 - :current_year, Webkul Software (in Indien registriert). Alle Rechte vorbehalten.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text' => '© Copyright 2019 - :current_year, Webkul Software (eingetragen in Indien). Alle Rechte vorbehalten.',
                'locale' => 'Sprache',
