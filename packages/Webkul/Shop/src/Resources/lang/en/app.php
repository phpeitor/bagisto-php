...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer' => '© Copyright 2019 - :current_year, Webkul Software (Registered in India). All rights reserved.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text' => '© Copyright 2019 - :current_year, Webkul Software (Registered in India). All rights reserved.',
                'locale' => 'Locale',
    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'mini-cart' => [
                ...
                'excl-tax' => 'Excl. Tax:',
                'offer-on-orders' => 'Get Up To 40% OFF on your 1st order',
                'remove' => 'Remove',
                'see-details' => 'See Details',
    ...
    'complaint-book' => [
        'create' => [
            ...
            'subtitle' => 'In accordance with Peru\'s Consumer Protection Code (Law No. 29571), this business provides a Complaints Book ("Libro de Reclamaciones") for your use. Filing a complaint does not prevent you from pursuing other dispute resolution avenues, nor is it a prerequisite for filing a report with INDECOPI.',
            'response-time-notice' => 'Your complaint or claim will be answered within a maximum of 15 business days.',
            'consumer-section' => '1. Consumer identification',
            'document-type' => 'Document type',
            'document-type-dni' => 'DNI',
            'document-type-ce' => 'Foreigner ID Card',
            ...
            'phone' => 'Phone',
            'email' => 'Email',
            'good-section' => '2. Good or service identification',
            'good-type' => 'Type of good contracted',
            'good-type-product' => 'Product',
            'good-type-service' => 'Service',
            'good-description' => 'Description of the product or service',
            'claimed-amount' => 'Claimed amount (S/, optional)',
            'claim-section' => '3. Complaint detail and consumer request',
            'type' => 'Type',
            'type-claim' => 'Claim',
            'type-claim-desc' => 'Dissatisfaction related to the products or services.',
            'type-complaint' => 'Complaint',
            'type-complaint-desc' => 'Dissatisfaction not related to the products or services; or discomfort regarding customer service.',
            'detail' => 'Detail',
            'request' => 'Consumer request',
            'accept-privacy' => 'I have read and accept that my data will be processed under the :link, in order to process this complaint.',
            'privacy-policy-link' => 'Privacy Policy',
            'submit' => 'Submit complaint',
            'success' => 'Your complaint was registered with No. :correlative. We will respond within 15 business days to the email you provided.',
            'lookup-not-found' => 'No information was found for the document entered. Please fill in your details manually.',
            'lookup-failed' => 'The document could not be verified right now. Please fill in your details manually.',
            'lookup-unavailable' => 'Automatic verification is not available. Please fill in your details manually.',
        ],
    ],
