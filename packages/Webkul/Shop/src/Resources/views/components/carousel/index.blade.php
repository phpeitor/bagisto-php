        ...
        <div class="relative m-auto flex w-full overflow-hidden">
            ...
            >
                <div
                    ...
                    ref="slide"
                >
                    <template v-if="isVideo(image.image)">
                        <video
                    ...
                    <template v-else>
                        <x-shop::media.images.lazy
                            ...
                            ::src="image.image"
                            ::srcset="getImageSrcset(image.image)"
                            ::sizes="
    ...
    <script type="module">
        app.component("v-carousel", {
            ...
            methods: {
                ...
                isVideo(imagePath) {
                    const normalizedPath = (imagePath || '').split('?')[0].toLowerCase();

                    return normalizedPath.endsWith('.webm');
                },
                ...
                playActiveSlideMedia() {
                    const activeIndex = Math.abs(this.currentIndex);
                ...
                getImageSrcset(imagePath) {
                    ...
                    if (normalizedPath.endsWith('.gif') || normalizedPath.endsWith('.webm')) {
                        return null;
                    }

                    return imagePath + ' 1920w, ' + imagePath.replace('storage', 'cache/large') + ' 1280w,' + imagePath.replace('storage', 'cache/medium') + ' 1024w, ' + imagePath.replace('storage', 'cache/small') + ' 525w';
                },
