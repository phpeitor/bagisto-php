...
class ComplaintBookConfirmation extends Mailable
{
    /**
    ...
    public function envelope(): Envelope
    {
        return new Envelope(
            ...
            subject: trans('shop::app.emails.complaint-book.subject', ['correlative' => $this->complaint->correlative]),
        );
    }
    ...
    {
        return new Content(
            view: 'shop::emails.complaint-book',
        );
    }
}
